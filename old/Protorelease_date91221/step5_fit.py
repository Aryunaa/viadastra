...
calc_pval aggregate -I /media/ElissarDisk/ADASTRA/fit/chip_pvals/chipseq_BAD_annotated.pvalue_table -O /media/ElissarDisk/ADASTRA/fit ; bash make_env.sh ; echo end
